...
type ServiceGetUserByIdInterface interface {
	ProcessServicesGetUsersById(userId string) (ServiceGetUserByIdResponse, error)
}
...
type ServiceGetUserByIdResponse struct {
	Status string                   `json:"status"`
	Data   []ServiceGetUserByIdData `json:"data"`
	Error  string                   `json:"error"`
}

type ServiceGetUserByIdData struct {
	UserID    int    `json:"userId"`
...
type ServiceGetUsersByIdHandler struct {
}

func NewGetUsersById() *ServiceGetUsersByIdHandler {
	return &ServiceGetUsersByIdHandler{}
}

func (g ServiceGetUsersByIdHandler) ProcessServicesGetUsersById(id string) (ServiceGetUserByIdResponse, error) {

	var responseInfo ServiceGetUserByIdResponse
	var tags []ServiceGetUserByIdData
	//var tagsArray []ServiceGetUserByIdData
	var tagsJson ServiceGetUserByIdData
	...
	*/
	...
	if resAnalize == "json" {
		...
		tags = []ServiceGetUserByIdData{tagsJson}
		responseInfo = ServiceGetUserByIdResponse{
			Status: "ok",
			Data:   tags,
			Error:  "",
